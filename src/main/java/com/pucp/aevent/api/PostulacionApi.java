		...
		try {
			...
			*/
			if(usuario.getEmail()!=null) {
				...
				texto = texto.replace(UtilMessage.PARAMETRO_NOMBRECOMPLETO, usuario.getNombreCompleto());
				texto = texto.replace(UtilMessage.PARAMETRO_TITULOEVENTO, evento.getTitulo());
