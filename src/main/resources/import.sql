...
INSERT INTO `evento` ( capacidad,titulo, descripcion, fecha_fin, fecha_inicio, id_formulariocfp, id_organizador, id_tipo_evento,estado, id_presidente, id_lugar) VALUES (500, 'Charla magistral dirigida a desarrolladores de software de prop�sito cient��fico','Charla magistral dirigida a desarrolladores de software de prop�sito cient�fico', '2019-12-12', '2019-05-05', 1, 3, 1,0,2,1);
