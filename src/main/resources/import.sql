...
INSERT INTO `categoria` (cod_categoria, descripcion,estado) VALUES ('00000006', 'CONSTRUCCIÃ“N CIVIL',1);
INSERT INTO `categoria` (cod_categoria, descripcion,estado) VALUES ('00000007', 'EDUCACIIÃ“N',1);

INSERT INTO `parametro` (DESCRIPCION,DESCRIPCION_CORTA, ACTIVO) VALUES ('Pregunta abierta','TIPO_PREGUNTA' , TRUE);
INSERT INTO `parametro` (DESCRIPCION,DESCRIPCION_CORTA, ACTIVO) VALUES ('Pregunta de opciÃ³n mÃºltiple','TIPO_PREGUNTA' , TRUE);
...
INSERT INTO `lugar` (descripcion, estado) VALUES("AUDITORIO DE CIENCIAS E INGENIERÃ�A - PUCP", 1);
...
INSERT INTO `formulariocfp` (id_fase,titulo) VALUES (2,"Formato de fase de evaluaciÃ³n");
...
INSERT INTO `evento` ( capacidad,titulo, descripcion, fecha_fin, fecha_inicio, id_organizador, id_tipo_evento,estado, id_presidente, id_lugar) VALUES (500, 'Charla magistral dirigida a desarrolladores de software de propÃƒÂ³sito cientÃ­fico','Charla magistral dirigida a desarrolladores de software de propÃ¯Â¿Â½sito cientÃ¯Â¿Â½fico', '2019-12-12', '2019-05-05', 3, 1,1,2,1);
INSERT INTO `evento` ( capacidad,titulo, descripcion, fecha_fin, fecha_inicio, id_organizador, id_tipo_evento,estado, id_presidente, id_lugar) VALUES (500, 'Mama, voy a ser dotero','Charla para jÃ³venes emprendedores +5k MMR', '2019-12-12', '2019-05-05', 3, 2,0,2,2);
INSERT INTO `evento` ( capacidad,titulo, descripcion, fecha_fin, fecha_inicio, id_organizador, id_tipo_evento,estado, id_presidente, id_lugar) VALUES (500, 'Marcha para que abran un Tambo en el congreso','Gran marcha nacional', '2019-12-12', '2019-05-05', 3, 3,1,2,1);
INSERT INTO `evento` ( capacidad,titulo, descripcion, fecha_fin, fecha_inicio, id_organizador, id_tipo_evento,estado, id_presidente, id_lugar) VALUES (500, 'IoT: PrÃ³ximamente tu refrigeradora tendrÃ¯Â¿Â½ cerebro','La tecnologÃ¯Â¿Â½a en 2k19', '2019-12-12', '2019-05-05', 3, 1,0,2,1);
...
INSERT INTO `tipo_criterio` (descripcion, estado) VALUES ('Respuesta numÃ©rica', 1);
INSERT INTO `tipo_criterio` (descripcion, estado) VALUES ('Respuesta mÃºltiple', 1);
INSERT INTO `tipo_criterio` (descripcion, estado) VALUES ('Pregunta de selecciÃ³n', 1);
...
INSERT INTO `criterio` (descripcion, id_fase, id_tipo_criterio) VALUES ("Nivel de detalle de la temÃ¡tica",3,5);
...
INSERT INTO `criterio` (descripcion, id_fase, id_tipo_criterio) VALUES ("Cumple con los estÃ¡ndares del evento",1,5);
...
INSERT INTO `opcion_respuesta_criterio` (descripcion, id_criterio) VALUES ("InvestigaciÃ³n exhaustiva",3);
